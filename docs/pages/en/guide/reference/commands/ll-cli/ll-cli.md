...
| enter     | [ll-cli-enter(1)](./enter.md)         | Enter the namespace of a running application                                            |
...
| analyze   | [ll-cli-analyze(1)](./analyze.md)     | Analyze disk usage and dependency relationships of installed applications               |
