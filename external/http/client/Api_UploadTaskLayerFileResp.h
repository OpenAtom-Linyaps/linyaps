...
#ifndef Api_UploadTaskLayerFileResp_H
#define Api_UploadTaskLayerFileResp_H
...
class Api_UploadTaskLayerFileResp : public Object {
public:
    Api_UploadTaskLayerFileResp();
    Api_UploadTaskLayerFileResp(QString json);
    ~Api_UploadTaskLayerFileResp() override;
...
Q_DECLARE_METATYPE(linglong::api::client::Api_UploadTaskLayerFileResp)

#endif // Api_UploadTaskLayerFileResp_H
