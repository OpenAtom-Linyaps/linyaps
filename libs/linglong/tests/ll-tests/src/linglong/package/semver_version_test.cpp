...
TEST(VersionTest, ValidVersions)
{
    ...
    EXPECT_NO_THROW(version::parse("v1", false));
    EXPECT_NO_THROW(version::parse("1", false));
}
...
TEST(VersionTest, VersionStrings)
{
    ...
    EXPECT_EQ(version::parse("v1", false).str(), "1.0.0");
    EXPECT_EQ(version::parse("1", false).str(), "1.0.0");
    ...
    EXPECT_EQ(version::parse("v1-alpha+build", false).str(), "1.0.0-alpha+build");
    EXPECT_EQ(version::parse("1-alpha+build", false).str(), "1.0.0-alpha+build");
