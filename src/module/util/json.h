...
#define D_SERIALIZE_DECLARE(TYPE) D_SERIALIZE_DECLARE_LIST(TYPE)

#define D_SERIALIZE_REGISTER_TYPE_NM(NM, TYPE) D_SERIALIZE_REGISTER_TYPE(NM::TYPE, NM::TYPE##List)
